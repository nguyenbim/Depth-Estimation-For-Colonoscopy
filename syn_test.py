...
print("loading data")
#load data
data_path = '/content/drive/MyDrive/CV_depth_colonoscopy_1/datasets/colon2depth'
#dirs = ["test_A", "train_A"]
dirs = ["test_A"]
...
for d in dirs:
    ...
    for img in imgs_path:
        ...
        depth_path = os.path.join("/content/drive/MyDrive/CV_depth_colonoscopy_1/datasets/colon2depth/test_B", depth_name)
