...
oc_dataset = OC_Dataset(root='/content/drive/MyDrive/CV_depth_colonoscopy_1/video_datasets/oc_train_dataset/TrainValid/Images', depth_transform=depth_transform)
