...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/content/CV_Vinbigdata/checkpoints', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='/content/drive/MyDrive/CV_depth_colonoscopy_1/datasets/colon2depth/')
